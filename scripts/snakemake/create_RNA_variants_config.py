...
with open('sample_read_group_info.txt', 'r') as infile:
    for line in infile:
        ...
        shortName1 = stemName + sampleAttributes[0] + '_' + sampleAttributes[1] + '_' + 'L1' + '_R1'
        shortName2 = stemName + sampleAttributes[0] + '_' + sampleAttributes[1] + '_' + 'L1' + '_R2'
        shortName3 = stemName + sampleAttributes[0] + '_' + sampleAttributes[1] + '_' + 'L2' + '_R1'
        shortName4 = stemName + sampleAttributes[0] + '_' + sampleAttributes[1] + '_' + 'L2' + '_R2'
        ...
        SM = sampleID  # Sample
        PU = flowcellID + "_" + lane  # Platform Unit
        LB = stemName
    ...
    "{0}":{{
        ...
        "PL": "Illumina"
        '''
        outfile.write(out.format(stemName, sampleName1, sampleName2, shortName1, shortName2, shortName3, shortName4, stemName, sampleID, PU, LB))
