...
LBD_FandM <- LBD_FandM[-c(3:5,7,10,11,13:19,22,23,25)]
...
LBD_uniquely_up_females_df_subset <-
  subset(LBD_uniquely_up_females_df, female_logFC > 0.25 & male_logFC < 0.025)
write.table(
  LBD_uniquely_up_females_df_subset,
  paste0(
    "../../results/",
...
LBD_uniquely_down_females_df_subset <-
  subset(LBD_uniquely_down_females_df, female_logFC < -0.25 & male_logFC > 0.025)
write.table(
  LBD_uniquely_down_females_df_subset,
  paste0(
    "../../results/",
...
LBD_uniquely_up_males_df_subset <-
  subset(LBD_uniquely_up_males_df, male_logFC > 0.25 & female_logFC < 0.025)
write.table(
  LBD_uniquely_up_males_df_subset,
  paste0(
    "../../results/",
...
LBD_uniquely_down_males_df_subset <-
  subset(LBD_uniquely_down_males_df, male_logFC < -0.25 & female_logFC > 0.025)
write.table(
  LBD_uniquely_down_males_df_subset,
  paste0(
    "../../results/",
...
AD_FandM <-
  merge(ADvsControl_XX_females,
        ...
        all = T)
# remove unnecessary columns 
AD_FandM <- AD_FandM[-c(3:5,7,10,11,13:19,22,23,25)]
...
AD_uniquely_up_females_df_subset <-
  subset(AD_uniquely_up_females_df, female_logFC > 0.25 & male_logFC < 0.025)
write.table(
  AD_uniquely_up_females_df_subset,
  paste0(
    "../../results/",
...
AD_uniquely_down_females_df_subset <-
  subset(AD_uniquely_down_females_df, female_logFC < -0.25 & male_logFC > 0.025)
write.table(
  AD_uniquely_down_females_df_subset,
  paste0(
    "../../results/",
...
AD_uniquely_up_males_df_subset <-
  subset(AD_uniquely_up_males_df, male_logFC > 0.25 & female_logFC < 0.025)
write.table(
  AD_uniquely_up_males_df_subset,
  paste0(
    "../../results/",
...
AD_uniquely_down_males_df_subset <-
  subset(AD_uniquely_down_males_df, male_logFC < -0.25 & female_logFC > 0.025)
write.table(
  AD_uniquely_down_males_df_subset,
  paste0(
    "../../results/",
...
PA_FandM <-
  merge(PAvsControl_XX_females,
        ...
        all = T)
# remove unnecessary columns 
PA_FandM <- PA_FandM[-c(3:5,7,10,11,13:19,22,23,25)]
...
PA_uniquely_up_females_df_subset <-
  subset(PA_uniquely_up_females_df, female_logFC > 0.25 & male_logFC < 0.025)
write.table(
  PA_uniquely_up_females_df_subset,
  paste0(
    "../../results/",
...
PA_uniquely_down_females_df_subset <-
  subset(PA_uniquely_down_females_df, female_logFC < -0.25 & male_logFC > 0.025)
write.table(
  PA_uniquely_down_females_df_subset,
  paste0(
    "../../results/",
...
PA_uniquely_up_males_df_subset <-
  subset(PA_uniquely_up_males_df, male_logFC > 0.25 & female_logFC < 0.025)
write.table(
  PA_uniquely_up_males_df_subset,
  paste0(
    "../../results/",
...
PA_uniquely_down_males_df_subset <-
  subset(PA_uniquely_down_males_df, male_logFC < -0.25 & female_logFC > 0.025)
write.table(
  PA_uniquely_down_males_df_subset,
  paste0(
    "../../results/",
