...
up_and_down_enrich_results_subset$Description <-
      gsub(
       "Trans-sulfuration, one-carbon metabolism and related pathways",
        "Trans-sulfuration, one-carbon metabolism",
        up_and_down_enrich_results_subset$Description
      )
up_and_down_enrich_results_subset$Description <-
...
```
# GO pathways shared DLBD & TLBD & LBD
```{r}
# read in enrichment analysis results
shared_up_enrich_results <-
  read.csv("../../../results/star/metascape/LBD_and_substypes_up_regulated/Enrichment_heatmap/HeatmapSelectedGO.csv")
...
shared_up_enrich_results$Description <-
      gsub(
       "negative regulation of cell population proliferation",
        "negative reg of cell population proliferation",
        shared_up_enrich_results$Description
      )
shared_up_enrich_results$Description <-
      gsub(
...
shared_up_enrich_results$variable <-
      gsub(
       "X_LogP_TLBDvsCtrl_up",
        "TLBD",
        shared_up_enrich_results$variable
      )
shared_up_enrich_results$variable <- factor(shared_up_enrich_results$variable, levels = c("TLBD", "DLBD", "LBD"))
# plot - up
...
"(" ~ italic("p") ~ "-value)")
  ...
  scale_fill_gradientn(
    ...
    theme(strip.text = element_text(size = 8), 
          ...
          legend.margin=margin(0,0.5,0,0),
          legend.box.margin=margin(-10,-2,-10,-7.5), 
          plot.margin = margin(0.5, 0.25, 0.025, 0.2, "cm"), #t,r,b,l
...
shared_down_enrich_results <-
  read.csv("../../../results/star/metascape/LBD_and_substypes_down_regulated/Enrichment_heatmap/HeatmapSelectedGO.csv")
...
shared_down_enrich_results$variable <-
      gsub(
       "X_LogP_DLBDvsCtrl_down",
        "DLBD",
        shared_down_enrich_results$variable
      )
shared_down_enrich_results$variable <-
      gsub(
       "X_LogP_LBDvsCtrl_down",
        "LBD",
        shared_down_enrich_results$variable
      )
shared_down_enrich_results$variable <-
      gsub(
       "X_LogP_TLBDvsCtrl_down",
        "TLBD",
        shared_down_enrich_results$variable
      )
shared_down_enrich_results$variable <- factor(shared_down_enrich_results$variable, levels = c("TLBD", "DLBD", "LBD"))
# plot - down
...
"(" ~ italic("p") ~ "-value)")
  ...
  scale_fill_gradientn(
    ...
    theme(strip.text = element_text(size = 8), 
          ...
          legend.margin=margin(0,0.5,0,0),
          legend.box.margin=margin(-10,-2,-10,-7.5), 
          plot.margin = margin(0.5, 0.2, 0.025, 0.025, "cm"), #t,r,b,l
...
path <- paste0("../../../results/manuscript_figures/Figure_1_LBD_v230828")
...
path <- paste0("../../../results/manuscript_figures/Supplemental_DLBD_vs_TLBD_and_within_DLBD")
