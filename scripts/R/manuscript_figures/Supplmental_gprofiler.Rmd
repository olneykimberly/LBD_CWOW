...
#plot_up <- publish_gostplot_intersect(p_up, highlight_terms = c("GO:0002682", "GO:0002684", "GO:0001944", "GO:1904018","GO:0031098",  "GO:0043549"))
plot_up <- publish_gostplot_intersect(p_up, highlight_terms = c("GO:0001944", "GO:0002684", "GO:0002682", "GO:0031098","GO:0043549", "GO:1904018"))
...
#plot_down <- publish_gostplot_intersect(p_down, highlight_terms = c("GO:0016491", "GO:0120178", "GO:0016054", "KEGG:01212", "WP:WP5241"))
plot_down <- publish_gostplot_intersect(p_down, highlight_terms = c("GO:0016054", "GO:0019752", "GO:0032787", "GO:0120178",  "KEGG:00280", "KEGG:01212"))
plot_down
...
```
```{r}
remove(combind, df, gp_down, gp_up, LBDvsControl, p_down, p_up, plot_down, plot_up, up, down)
```
# AD vs Control
```{r ADvsControl}
i <- "ADvsControl"
...
gostplot(gp_up, interactive = TRUE)
p_up = gostplot(gp_up, interactive = FALSE)
#plot_up <- publish_gostplot_intersect(p_up, highlight_terms = c("GO:0005515", "GO:0031982", "GO:0012501", "REAC:R-HSA-9711097", "WP:WP477"))
plot_up <- publish_gostplot_intersect(p_up, highlight_terms = c("GO:0019901","GO:0001816", "GO:0006950",  "GO:0006468","GO:0034097"))
plot_up
path <- paste0("../../../results/", tool, "/gprofiler/", i, "_up_gprofiler")
pdf(paste0(path, ".pdf"), height = 6, width = 8)
print(plot_up)
...
gostplot(gp_down, interactive = TRUE)
p_down = gostplot(gp_down, interactive = FALSE)
#plot_down <- publish_gostplot_intersect(p_down, highlight_terms = c("GO:0016491", "GO:0005739", "GO:0016054", "GO:0044281", "KEGG:00280", "WP:WP143"))
plot_down <- publish_gostplot_intersect(p_down, highlight_terms = c("GO:0044282","GO:0046395"))
plot_down
path <- paste0("../../../results/", tool, "/gprofiler/", i, "_down_gprofiler")
pdf(paste0(path, ".pdf"), height = 6, width = 8)
print(plot_down)
...
path <- paste0("../../../results/manuscript_figures/Supplemental_Figure_AD_vs_Control_gProfiler_bubble")
saveToPDF(paste0(path, ".pdf"), width = 8.5, height = 11)
```

```{r}
remove(combind, df, gp_down, gp_up, ADvsControl, p_down, p_up, plot_down, plot_up, up, down)
```
# LBD vs AD
```{r LBDvsAD}
i <- "LBDvsAD"
...
gostplot(gp_up, interactive = TRUE)
p_up = gostplot(gp_up, interactive = FALSE)
#plot_up <- publish_gostplot_intersect(p_up, highlight_terms = c("GO:0030594", "GO:0045202", "GO:0043005", "GO:0007268", "GO:0099537", "REAC:R-HSA-1296072", "WP:WP58"))
plot_up <- publish_gostplot_intersect(p_up, highlight_terms = c("GO:0007210","GO:0007610", "GO:0030900", "GO:0050804", "GO:0099536"))
plot_up 
path <- paste0("../../../results/", tool, "/gprofiler/", i, "_up_gprofiler")
pdf(paste0(path, ".pdf"), height = 6, width = 8)
print(plot_up)
...
gostplot(gp_down, interactive = TRUE)
p_down = gostplot(gp_down, interactive = FALSE)
#plot_down <- publish_gostplot_intersect(p_down, highlight_terms = c("GO:0003735", "GO:0005840", "KEGG:03010", "CORUM:306", "WP:WP477", "HPA:0250133"))
plot_down <- publish_gostplot_intersect(p_down, highlight_terms = c("GO:0007005","CORUM:306" ))
plot_down
path <- paste0("../../../results/", tool, "/gprofiler/", i, "_down_gprofiler")
pdf(paste0(path, ".pdf"), height = 6, width = 8)
print(plot_down)
...
path <- paste0("../../../results/manuscript_figures/Supplemental_Figure_LBD_vs_AD_gProfiler_bubble")
saveToPDF(paste0(path, ".pdf"), width = 8.5, height = 11)
```
