...
write.table(down_enrich_results, "LBD_vs_control_down_enrichment.txt", sep = "\t", quote = FALSE)
```
...
write.table(down_enrich_results_subset, "LBD_vs_control_down_enrichment.txt", sep = "\t", quote = FALSE)
...
write.table(up_enrich_results_subset, "LBD_vs_control_up_enrichment.txt", sep = "\t", quote = FALSE)
getwd()
```
...
#path <- paste0("../../../results/manuscript_figures/Figure_1_LBD")
...
combind <-
  ggarrange(
    row1, # separate script 
    row3,
    row2,
    nrow = 3,
    heights = c(1.3, .95, 1.1)
    )
combind
