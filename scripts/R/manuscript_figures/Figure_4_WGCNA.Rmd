...
path <- paste0("../../../results/manuscript_figures/Figure_WGCNA_dendrogram")
...
module_trait_corr_pval_fdr <- module_trait_corr_pval_df%>%mutate(across(contains("p-value"), ~ p.adjust(.x, method = "fdr", n = length(.x))))
...
path <- paste0("../../../results/manuscript_figures/Figure_4_WGCNA_TYPE_updated_FDRq")
