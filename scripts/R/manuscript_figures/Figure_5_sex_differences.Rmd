...
Female_LBD_vs_control_volcano <- ggplot(data = data,
      ...
      theme(legend.position = "none", 
        plot.margin = margin(0.1, 0.2, 0, 0.2, "cm"), 
             ...
             plot.title = element_text(size = 10, margin = margin(0,0,0,0))) +
...
LBD_upset_gene <- upset(data, set_sizes = FALSE,
...
AD_upset_gene <- upset(data, set_sizes = FALSE,
      c('female down-regulated',
        'male down-regulated',
        'female up-regulated',
        'male up-regulated'),
...
AD_FandM <- subset(AD_FandM, difference > 1.1 | difference < -.75)
