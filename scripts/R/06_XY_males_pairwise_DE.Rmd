...
### metadata
```{r read_data}
metadata <- subset(metadata, sex_inferred == "male")
...
path <- paste0("../../results/", tool, "/MDS/", 
               condition,"_", min_expression, "_raw_MDS_label_type_dim1&2")
...
title(expression('Top 100 Genes (Log'[2]~'CPM)'))
path <- paste0("../../results/", tool, "/MDS/", 
               condition,"_", min_expression, "_raw_MDS_label_type_dim2&3")
saveToPDF(paste0(path, ".pdf"), width = 5.2, height = 5.2)
```
...
path <- paste0("../../results/", tool, "/MDS/", 
               condition, "_", min_expression, "_filtered_MDS_label_type_dim1&2")
saveToPDF(paste0(path, ".pdf"), width = 5.2, height = 5.2)
```
...
path <- paste0("../../results/", tool, "/MDS/", condition, 
               "_", min_expression,"_filtered_MDS_voom_type")
