...
df$ATS_names <- factor(df$ATS_names, levels = c("amyloid + synuclein + tau", "high amyloid + synuclein", "low amyloid + synuclein", "pure synuclein", "amyloid + tau", "amyloid", "no pathology"))
