...
condition <- c("All_samples_default_alignment")
...
write.table(data, paste0("../../results/", tool, "/sex_check/sex_check_data.txt"), sep = "\t")
write.table(wrong_sex_samples, paste0("../../results/", tool, "/sex_check/wrong_sex_samples.txt"), sep = "\t")
...
path <-
  paste0("../../results/", tool, "/sex_check/LBD_gene_raw_sex_check_samples_labeled")
