...
# umbrella cell type
```{r read_BinB}
zscores <- read_csv("/research/labs/neurology/fryer/m239830/LBD_CWOW/results/star/cell_type_enrichment/BrainInABlender/Detailed_CellTypeAnalysisOutput/ZscoreInput_Expression_CellType_NoPrimaryOverlap.csv")
...
for (i in 1:length(CellType_splits_umbrella)) {      # Run for-loop
  ...
  CellType_splits_umbrella[[i]]  <- CellType_splits_umbrella[[i]] [ -c(1,3:16) ]
...
umbrella_zscores <- rbind(Astrocyte.Umbrella, Endothelial.Umbrella, Microglia.Umbrella, Mural.Umbrella, Neuron.Umbrella, Oligodendrocyte.Umbrella, RBC.Umbrella)
