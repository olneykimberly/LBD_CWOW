...
tool = c("star_LBD_sub_type_Braak") # change condition for folder naming 
...
dge$samples$Braak.NFT.binary <-  ifelse(dge$samples$Braak.NFT >= 5, 1, 0) 
...
contrasts <- makeContrasts(
  ...
  DLBD_1_vs_DLBD_0 = DLBD_1 - DLBD_0,
  DLBD_1_vs_TLBD = DLBD_1 - TLBD, 
  DLBD_0_vs_TLBD = DLBD_0 - TLBD, 
...
"DLBD_1_vs_DLBD_0" = DLBD_1_vs_DLBD_0,
"DLBD_1_vs_TLBD" = DLBD_1_vs_TLBD,
"DLBD_0_vs_TLBD" = DLBD_0_vs_TLBD)
