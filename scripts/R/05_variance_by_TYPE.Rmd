...
condition <- c("protein_coding_ATS") #  protein_coding, okay to leave ATS names to keep the same samples 
...
condition <- c("protein_coding_TYPE") #  protein_coding, okay to leave ATS names 
design <-
  model.matrix(~ 0 + 
      TYPE + 
      sex_inferred + 
