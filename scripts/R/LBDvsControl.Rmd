...
metadata <- subset(metadata, TYPE == condition | TYPE == "CONTROL")
...
colnames(design) <- c(CONTROL, AD, PA, LBD, "RIN", "Age", "sex", "Asian_American","Caucasian","Eastern_Indian", "Hispanic")
 # "E2E4", "E3E3", "E3E4", "E4E4"
```
...
# glimma
```{r}
saveRDS(veBayesFit, file = paste0("../../rObjects/", comparison, ".veBayesFit.rds"))

veBayesFit <- readRDS(paste0("../../rObjects/", comparison, ".veBayesFit.rds"))
```
