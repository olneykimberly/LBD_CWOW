...
Sir_UnMixALot<- function(userInput, dataColumns, geneColumn, species){
  ...
  CellTypeSpecificGenes_Master3 <- read.table("/research/labs/neurology/fryer/m239830/LBD_CWOW/scripts/R/brain_blender_modified_cell_marker_table.tsv", header=T, sep = "\t")
