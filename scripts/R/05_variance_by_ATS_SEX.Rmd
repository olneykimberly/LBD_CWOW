...
dge.filtered.norm$samples$ATS_sex_inferred <-
  paste0(dge.filtered.norm$samples$ATS_names,
         " ",
...
dge.filtered.norm$samples$ATS_sex_inferred <-
  factor(
    ...
    levels = c(
      ...
      "amyloid + tau male",
      "amyloid + tau female",
      "low amyloid + synuclein male",
      "low amyloid + synuclein female",
      "high amyloid + synuclein male",
      "high amyloid + synuclein female", 
      "amyloid + synuclein + tau male",
      "amyloid + synuclein + tau female"
    )
  )
info$ATS_sex_inferred <- dge.filtered.norm$samples$ATS_sex_inferred
```
# scale information
```{r }
scaled.info <-
...
condition <- c("protein_coding_ATS_SEX") #  protein_coding, okay to leave ATS names 

formula <- (~ 0 + ATS_sex_inferred)
voom_with_weights <-
...
colnames(design) <-
  c("no_pathology_male",
      ...
      "amyloid_tau_male",
      "amyloid_tau_female",
      "low_amyloid_synuclein_male",
      "low_amyloid_synuclein_female",
      "high_amyloid_synuclein_male",
      "high_amyloid_synuclein_female", 
      "amyloid_synuclein_tau_male",
      "amyloid_synuclein_tau_female",
 #   "RIN",
    "Batch1",
    "Batch2",
    "Batch3",
...
contrasts <- makeContrasts(
  # No sex correction, disease vs no pathology 
  amyloid_vs_no_pathology_no_sex_correction = (amyloid_male + amyloid_female)/2 - (no_pathology_male + no_pathology_female)/2,
  amyloid_tau_vs_no_pathology_no_sex_correction = (amyloid_tau_male + amyloid_tau_female)/2 - (no_pathology_male + no_pathology_female)/2,
  low_amyloid_synuclein_vs_no_pathology_no_sex_correction = (low_amyloid_synuclein_male + low_amyloid_synuclein_female)/2 - (no_pathology_male + no_pathology_female)/2,
  high_amyloid_synuclein_vs_no_pathology_no_sex_correction = (high_amyloid_synuclein_male + high_amyloid_synuclein_female)/2 - (no_pathology_male + no_pathology_female)/2,
  amyloid_synuclein_tau_vs_no_pathology_no_sex_correction = (amyloid_synuclein_tau_male + amyloid_synuclein_tau_female)/2 - (no_pathology_male + no_pathology_female)/2,
  # within each sex 
  male_XY_amyloid_vs_no_pathology = amyloid_male - no_pathology_male,
  male_XY_amyloid_tau_vs_no_pathology = amyloid_tau_male  - no_pathology_male,
  male_XY_low_amyloid_synuclein_vs_no_pathology = low_amyloid_synuclein_male - no_pathology_male,
  male_XY_high_amyloid_synuclein_vs_no_pathology = high_amyloid_synuclein_male  - no_pathology_male,
  male_XY_amyloid_synuclein_tau_vs_no_pathology = amyloid_synuclein_tau_male - no_pathology_male,

  female_XX_amyloid_vs_no_pathology = amyloid_female - no_pathology_female,
  female_XX_amyloid_tau_vs_no_pathology = amyloid_tau_female  - no_pathology_female,
  female_XX_low_amyloid_synuclein_vs_no_pathology = low_amyloid_synuclein_female - no_pathology_female,
  female_XX_high_amyloid_synuclein_vs_no_pathology = high_amyloid_synuclein_female  - no_pathology_female,
  female_XX_amyloid_synuclein_tau_vs_no_pathology = amyloid_synuclein_tau_female - no_pathology_female,
  
  # between the sexes 
  female_amyloid_synuclein_tau_vs_male_amyloid_synuclein_tau = amyloid_synuclein_tau_female - amyloid_synuclein_tau_male, 
  female_amyloid_tau_vs_male_amyloid_tau = amyloid_tau_female - amyloid_tau_male, 
  female_amyloid_vs_male_amyloid = amyloid_female - amyloid_male, 
  female_low_amyloid_synuclein_vs_male_low_amyloid_synuclein = low_amyloid_synuclein_female - low_amyloid_synuclein_male,
  female_high_amyloid_synuclein_vs_male_high_amyloid_synuclein = high_amyloid_synuclein_female  - high_amyloid_synuclein_male,
  female_no_pathology_vs_male_no_pathology = no_pathology_female - no_pathology_male, 
  
  # sex interaction 
  amyloid_tau_vs_no_pathology_sex_interaction = ((amyloid_tau_female -  no_pathology_female) - (amyloid_tau_male - no_pathology_male)),
  amyloid_vs_no_pathology_sex_interaction = ((amyloid_female - no_pathology_female) - (amyloid_male - no_pathology_male)),
  amyloid_synuclein_tau_vsno_pathology_sex_interaction = ((amyloid_synuclein_tau_female - no_pathology_female) - (amyloid_synuclein_tau_male - no_pathology_male)),
  amyloid_synuclein_tau_vsamyloid_tau_sex_interaction = ((amyloid_synuclein_tau_female - amyloid_tau_female ) - (amyloid_synuclein_tau_male - amyloid_tau_male)),
  amyloid_synuclein_tau_vsamyloid_sex_interaction = ((amyloid_synuclein_tau_female - amyloid_female ) - (amyloid_synuclein_tau_male - amyloid_male)),
  amyloid_tau_vs_amyloid_sex_interaction = ((amyloid_tau_female - amyloid_female) - (amyloid_tau_male - amyloid_male)),
...
write.table(sumTable, 
            paste0("../../results/", tool, "/DEGs/", condition, "_DEGs_summary.tsv"), 
            quote = FALSE, 
            sep = "\t")
```
...
test <- topTable(
  veBayesFit, 
  coef = "male_XY_amyloid_tau_vs_no_pathology", # female_AD_vs_male_AD, female_Control_vs_male_Control,  ADvsControl, ADvsControl_interaction_female, ADvsControl_interaction_male, female_ADvsControl, male_ADvsControl
  n = Inf, 
  p.value = 1,
  lfc = 0, 
  sort.by = "P", 
...
```{r}
form_varPart <- ~ (1|ATS_sex_inferred) + 
  (1|flowcell_and_lane) +
  Age +
 # RIN +
  Neuron_All.Zscore +
