...
# Save R object
```{r, eval=FALSE}
saveRDS(dge, file = paste0("../../rObjects/LBD_dge.raw.rds"))
dge.filtered.norm <- readRDS(paste0("../../rObjects/LBD_dge.raw.rds"))
```
...
path <-
  paste0("../../results/", tool, "/sex_check/LBD_gene_raw_sex_check")
