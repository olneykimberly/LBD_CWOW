...
```{r variance_partition,  message=FALSE, warnings=FALSE, eval=FALSE, echo=FALSE}
...
```{r variance_violins, message=FALSE, warnings=FALSE, eval=FALSE, echo=FALSE}
# plot
plotVarPart(vp)
...
```{r variance_percent_bars, message=FALSE, warnings=FALSE, eval=FALSE, echo=FALSE}
# plot
...
# Top variable genes
```{r variance_group,  message=FALSE, warnings=FALSE, eval=FALSE, echo=FALSE}
...
for (i in allComparisons) {
  ...
  path <- paste("../../results/", tool, "/DEGs/LBD_gene_DEGs_FDRq1.00_XX.txt", sep = "") 
  write.table(
    vTopTableAll,
    path,
    sep = "\t",
  ...
  path <- paste("../../results/", tool, "/DEGs/LBD_gene_DEGs_FDRq0.05_XX.txt", sep = "") 
  write.table(
    vTopTable1,
    path,
    sep = "\t",
...
condition_vs_control <- read.table(
  paste0("../../results/", tool, "/DEGs/LBD_gene_DEGs_FDRq1.00_XX.txt", sep = ""),
  header = TRUE,
  sep = "\t",
...
# save
path <- paste0("../../results/", tool, "/volcano/LBD_gene_volcano_FDRq0.05_XX")
saveToPDF(paste0(path, ".pdf"), width = 5.2, height = 5.2)
```
