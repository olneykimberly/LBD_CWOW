...
goi <- subset(genes, gene_name == "PINK1" | gene_name == "PRKN") # gene of interest 
# subset counts 
...
column_variables <- c("ENSG00000158828.8") # gene_id to plot expression data for
colors <- TypeColors


PINK1 = subset(PINK1, select = c(NPID, TYPE, gene_id, value))
PRKN = subset(PRKN, select = c(NPID, TYPE, gene_id, value))
write.table(PINK1, "../../results/star/goi/PINK1.txt", sep = "\t", quote = FALSE, row.names = FALSE)
write.table(PRKN, "../../results/star/goi/PRKN.txt", sep = "\t", quote = FALSE, row.names = FALSE)
...
plotnames = imap(violin_plots, ~paste0("../../results/", tool, "/goi/PINK1.TYPE.pdf")) %>% #
  flatten()
plotnames
...
plotnames = imap(violin_plots, ~paste0("../../results/", tool, "/goi/PINK1.LBD.type.pdf")) %>% #
  flatten()
plotnames
walk2(plotnames, violin_plots, ~ggsave(filename = .x, plot = .y, 
                                    height = 5.5, width = 8))
...
plotnames = imap(violin_plots, ~paste0("../../results/", tool, "/goi/PINK1.TLBD_DLBD.pdf")) %>% #
  flatten()
plotnames
walk2(plotnames, violin_plots, ~ggsave(filename = .x, plot = .y, 
                                    height = 5.5, width = 6))
