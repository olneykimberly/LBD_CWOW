...
goi <- subset(genes, gene_name == "TTR") # gene of interest 
# subset counts 
...
```{r}
column_variables <- c("ENSG00000118271.12") # gene_id to plot expression data for
...
colors <- brewer.pal(n = 2, name = "RdBu") # colors red to blue 
```
...
plotnames = imap(violin_plots, ~paste0("../../results/", tool, "/goi/TTR.TYPE.pdf")) %>%
  flatten()
plotnames
