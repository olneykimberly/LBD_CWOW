...
goi <- subset(genes, gene_name == "ROS1") # gene of interest 
# subset counts 
...
```{r}
column_variables <- c("ENSG00000047936.11") # gene_id to plot expression data for
...
plotnames = imap(violin_plots, ~paste0("../../results/", tool, "/goi/ROS1.TYPE.pdf")) %>%
  flatten()
plotnames
