...
```{r loop, echo=FALSE}
allComparisons <- c("LBDvsControl", "LBDvsAD", "LBDvsPA", "ADvsControl",  "ADvsPA") # no DEGs "PAvsControl"
...
write.xlsx(list_of_datasets, file = paste0(
    "../../results/",
    tool,
    "/gprofiler/", condition,"_up_gene_descriptions.txt.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "../../results/",
    tool,
    "/gprofiler/", condition,"_down_gene_descriptions.txt.xlsx"))
```
# GO Plot
