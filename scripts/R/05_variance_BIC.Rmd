...
condition <- c("all_genes") # or all_genes
...
plotnames = imap(violin_plots, ~paste0("../../results/", tool, "/blood_markers/Type._BIC_", .y, ".pdf")) %>%
  flatten()
plotnames
...
plotnames = imap(violin_plots, ~paste0("../../results/", tool, "/blood_markers/VaD._BIC_", .y, ".pdf")) %>%
  flatten()
plotnames
walk2(plotnames, violin_plots, ~ggsave(filename = .x, plot = .y, 
                                    height = 4, width = 5.5))
