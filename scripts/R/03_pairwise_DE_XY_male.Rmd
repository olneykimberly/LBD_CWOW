...
metadata <- subset(metadata, sex_inferred == whichSex)
...
colnames(design) <- c(CONTROL, AD, PA, LBD, "RIN", "Age", "E2E4", "E3E3", "E3E4", "E4E4", "Asian_American", "Caucasian", "Hispanic", "Native_American")
```
...
p_vol <-
  ...
  theme(axis.title.x = element_text(size = 16),
        ...
        plot.title = element_text(size = 18, colour = "olivedrab")) +
