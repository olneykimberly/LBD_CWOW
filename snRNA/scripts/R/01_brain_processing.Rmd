...
if (tissue == "Brain" && file.exists("../../rObjects/brain.rds")) {
  dataObject <- readRDS("../../rObjects/brain.rds")
  ...
  remove(beads, debris)
  saveRDS(dataObject, "../../rObjects/brain.rds")
} 
```
# Change indents
```{r change_idents}
...
# save v1
v1
path <- paste0("../../results/seurat/violin/",treatment,"_",tolower(tissue),"_nFeature_nCount_complexity_raw")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
dev.off()

# save v2
v2
path <- paste0("../../results/seurat/violin/",treatment,"_",tolower(tissue),"_percent_raw")
...
# save
s1
path <- paste0("../../results/seurat/scatter/",treatment,"_",tolower(tissue),"_nFeature_vs_nCount_raw")
...
# save
s2
path <- paste0("../../results/seurat/scatter/",treatment,"_",tolower(tissue),"_nCount_vs_percentMT_raw")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
...
for (i in 1:length(dataObject.split)) {
  ...
  d1 <- DimPlot(data_sample,
        ...
        label = TRUE,
        label.size = 6)
  path <- paste0("../../results/seurat/doublet_finder/",treatment,"_",tolower(tissue),
  ...
  write.table(table(DF_class), paste0("../../results/seurat/doublet_finder/",treatment,"_",tolower(tissue),
  ...
  write.table(ncells_per_cluster, paste0(
    "../../results/seurat/doublet_finder/",treatment,"_",tolower(tissue),
...
```{r,echo=FALSE}
#saveRDS(dataObject.singlets, paste0("../../rObjects/",tolower(tissue),"_filtered_singlets.rds"))
#saveRDS(dataObject.filtered, paste0("../../rObjects/",tolower(tissue),"_filtered.rds"))
...
# save
grid1 <- grid.arrange(grobs = plots1, layout_matrix = layout1)
path <- paste0("../../results/seurat/histogram/",treatment,"_",tolower(tissue), "_",
               goi,"_histogram")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
...
# save
grid2 <- grid.arrange(grobs = plots2, layout_matrix = layout2)
path <- paste0("../../results/seurat/bar/",treatment,"_",tolower(tissue), 
               "_cells_per_sample")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 4)
...
# save
grid3 <- grid.arrange(grobs = plots3, layout_matrix = layout3)
path <- paste0("../../results/seurat/density/",treatment,"_",tolower(tissue), 
               "_density")
...
# save
v3
path <- paste0("../../results/seurat/violin/",treatment,"_",tolower(tissue), 
...
# save
s3
path <- paste0("../../results/seurat/scatter/",treatment,"_",tolower(tissue),
...
# save
b1
path <- paste0("../../results/seurat/box/",treatment,"_",tolower(tissue),
...
```{r,echo=FALSE}
write.table(df, paste0("../../results/seurat/top_transcripts/", tolower(tissue), "_abundant_transcripts.txt"),
            quote = FALSE,
            row.names = FALSE)
```
...
# save
cellcyclecount_barplot
path <- paste0("../../results/seurat/cell_cycle/",treatment,"_",tolower(tissue),
               "_cellcycle_bargraph")
saveToPDF(paste0(path, ".pdf"), width = 4, height = 4)
...
```{r,echo=FALSE,message=FALSE,warning=FALSE}
# save
path <- paste0("../../results/seurat/variance/",treatment,"_",tolower(tissue),
...
```{r,echo=FALSE,message=FALSE,warning=FALSE}
# save pca2
path <- paste0("../../results/seurat/PCA/",treatment,"_",tolower(tissue),
...
#saveRDS(dataObject.integrated, paste0("../../rObjects/",tolower(tissue),"_preclustering.rds"))
#dataObject.integrated <- readRDS(paste0("../../rObjects/",tolower(tissue),"_preclustering.rds"))
```
...
#saveRDS(dataObject.unannotated, paste0("../../rObjects/",tolower(tissue),"_unannotated.rds"))
#dataObject.unannotated <- readRDS(paste0("../../rObjects/",tolower(tissue),"_unannotated.rds"))
```
...
```{r,echo=FALSE,message=FALSE,warning=FALSE}
# save umap0.1
path <- paste0("../../results/seurat/UMAP/unannotated/",treatment,"_",tolower(tissue),
...
```{r,echo=FALSE,message=FALSE,warning=FALSE}
# save
path <- paste0("../../results/seurat/feature/",treatment,"_",tolower(tissue),
